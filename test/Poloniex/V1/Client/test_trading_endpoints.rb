...
describe "Poloniex::V1::Client Trading Endpoints" do
  ...
  # Need to fix http.rb first. See implementation for more.
  ...
  #     VCR.use_cassette('tmp/create_multiple_orders') do
  #       response = subject.create_multiple_orders([order0, order1])
  #       _(response).must_by_kind_of(Hash)
  #     end
  #   end
  # end
  ...
  describe "#cancel_replace_order" do
    it "" do
      VCR.use_cassette('v1/cancel_replace_order') do
        response = subject.cancel_replace_order(order_id: 'green')
  ...
  #   it "" do
  #     VCR.use_cassette('tmp/cancel_all_orders') do
  #       response = subject.order_details
  #       assert_kind_of Hash, response
  #     end
  #   end
  # end
